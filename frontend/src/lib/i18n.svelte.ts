...
export const translations: Record<Locale, Record<string, string>> = {
  'pt-PT': {
    ...
    'counters.quickIncrements': 'Incrementos Rápidos',
    ...
    'counters.customAdjust': 'Ajuste Personalizado',
    ...
    'settings.namePlaceholder': 'ex: Consumo de Água, Passos Diários',
    'settings.unitLabel': 'Unidade (texto livre)',
    'settings.unitPlaceholder': 'ex: Litros, repetições, copos, km',
    'settings.decimalPrecision': 'Precisão Decimal',
